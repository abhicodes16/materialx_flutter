...
class ArticleMediumDarkRoute extends StatefulWidget {

  ArticleMediumDarkRoute();

  @override
  ArticleMediumDarkRouteState createState() => new ArticleMediumDarkRouteState();
}


class ArticleMediumDarkRouteState extends State<ArticleMediumDarkRoute> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(heroTag: "fab1",
        backgroundColor: MyColors.grey_90, elevation: 3,
        child: Icon(Icons.thumb_up, color: MyColors.grey_10),
      ...
      body: CustomScrollView(
        slivers: <Widget>[
          SliverAppBar(
              ...
              leading: IconButton(icon: Icon(Icons.arrow_back, color: MyColors.grey_40),
                onPressed: () { Navigator.pop(context);},
              ),
              actions: <Widget>[
                IconButton(icon: Icon(Icons.share, color: MyColors.grey_40), onPressed: () {}),
                IconButton(icon: Icon(Icons.bookmark_border, color: MyColors.grey_40), onPressed: () {}),
              ]
          ),
          SliverList(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(MyStrings.very_long_lorem_ipsum, textAlign: TextAlign.justify,
                          style: MyText.medium(context).copyWith(color: MyColors.grey_40)
                      ),
                    ),
                    Container(
                      child: Row(
