    ...
    return Wrap(
      ...
      children: <Widget>[
        Card(
            ...
            color: isMe ? Color(0xffE1FFC7) : Colors.white, elevation: 1,
            child : Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Text(item.date, textAlign: TextAlign.end, style: TextStyle(fontSize: 12, color: MyColors.grey_40)),
                      Container(width: 3),
                      isMe ? Icon(Icons.done_all, size: 12, color: Color(0xff42BDEE)) : Container(width: 0, height: 0)
                    ],
                  )
                ],
              ),
